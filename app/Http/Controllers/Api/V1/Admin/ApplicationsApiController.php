...
class ApplicationsApiController extends Controller
{
    public function index()
    {
        ...
        return new ApplicationResource(Application::with(['property_applying', 'unit_applying', 'tenant'])->get());
    }
    ...
    public function show(Application $application)
    {
        ...
        return new ApplicationResource($application->load(['property_applying', 'unit_applying', 'tenant']));
    }
