    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.expenses.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_expense') ? 'is-invalid' : '' }}" type="text" name="date_of_expense" id="date_of_expense" value="{{ old('date_of_expense') }}" required>
