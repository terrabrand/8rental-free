    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.invoices.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('partial_amount') ? 'is-invalid' : '' }}" type="number" name="partial_amount" id="partial_amount" value="{{ old('partial_amount', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_paid') ? 'is-invalid' : '' }}" type="text" name="date_paid" id="date_paid" value="{{ old('date_paid') }}">
